...
public class PrepareUpdateLibroServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			request.setAttribute("update_libro_attr",
					MyServiceFactory.getLibroServiceInstance().caricaSingoloElemento(Long.parseLong(idLibroParameter)));
		} catch (Exception e) {
			e.printStackTrace();
		...
		RequestDispatcher rd = request.getRequestDispatcher("/libro/update.jsp");
